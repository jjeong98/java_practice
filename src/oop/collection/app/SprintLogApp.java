...
public class SprintLogApp {
	...
	public static void main(String[] args) {
		...
		LearningActivity lecture2 = new LectureLog(
				"1235534", 30, Visibility.PUBLIC, "이코치");
		LearningActivity lecture3 = new LectureLog(
				"def론", 70, Visibility.PUBLIC, "김코치");
		...
		for (ActivityCategory cat : ActivityCategory.values()) {
			...
			if (group == null) {
				...
				for (LearningActivity a : group) {
					System.out.println("  - " + a.getTitles() + " (" + a.getMinutes() + "분)");
				}
			}
		}
